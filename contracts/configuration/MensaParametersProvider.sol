...
/**
* @title MensaParametersProvider
* @notice stores the configuration parameters of the Mensa contract
**/

contract MensaParametersProvider is VersionedInitializable {
    ...
    /**
    * @dev initializes the MensaParametersProvider after it's added to the proxy
    * @param _addressesProvider the address of the MensaAddressesProvider
    */
