...
///  - If the address(0) is used as receiver, this contract will trade in Kyber to tokenToBurn 
...
contract TokenDistributor is Ownable, VersionedInitializable {
    ...
    address public constant KYBER_ETH_MOCK_ADDRESS = address(0x001111111111111111111111111111111111111111);
    ...
    /// @notice The address of the token to burn 
