...
/**
* @title MensaDataProvider contract
* @author Mensa
...
**/
contract MensaDataProvider is VersionedInitializable {
    ...
    **/
    ...
    function initialize(MensaAddressesProvider _addressesProvider) public initializer {
        ...
        core = MensaCore(_addressesProvider.getMensaCore());
    }
   ...
   **/
    ...
    **/
    ...
    /**
    * @dev accessory functions to fetch data from the mensaCore
    **/
