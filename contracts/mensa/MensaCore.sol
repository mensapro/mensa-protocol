...
/**
* @title MensaPoolCore contract
* @notice Holds the state of the mensa and all the funds deposited
...
* The check that an action can be performed is a duty of the overlying mensa contract.
**/

contract MensaCore is VersionedInitializable {
    ...
    **/
    ...
    address public mensaAddress;

    MensaAddressesProvider public addressesProvider;

    /**
    * @dev only mensa can use functions affected by this modifier
    **/
    modifier onlyMensa {
        require(mensaAddress == msg.sender, "The caller must be a mensa contract");
        _;
    }
    ...
    * @dev only mensa can use functions affected by this modifier
    **/
    modifier onlyMensaStaff {
        require(mensaAddress == msg.sender ||  
        addressesProvider.getMensaLiquidationManager() == msg.sender, "The caller must be a mensa contract");
        _;
    }

    /**
    * @dev only mensa configurator can use functions affected by this modifier
    **/
    modifier onlyMensaConfigurator {
        require(
            addressesProvider.getMensaConfigurator() == msg.sender,
            "The caller must be a mensa configurator contract"
        );
        _;
    }
    ...
    **/
    ...
    ) external onlyMensa returns (uint256, uint256) {
    ...
    **/
    ...
    ) external onlyMensa returns (CoreLibrary.InterestRateMode, uint256) {
    ...
    * @param _balanceIncrease the accrued interest on the borrowed amount
    * @param _liquidatorReceivesMToken true if the liquidator will receive mTokens, false otherwise
    **/
    ...
    **/
    function() external payable {
        ...
        require(msg.sender.isContract(), "Only contracts can send ether to the mensa core");
    ...
    **/
    function liquidateFee(
        ...
        uint256 _amount,
        address _destination
    ) external payable onlyMensaStaff {
        address payable feeAddress = address(uint160(_destination)); //cast the address to payable
        require(
            msg.value == 0,
    ...
    * needed to calculate the global account data in the MensaDataProvider
    ...
    **/
    ...
    /**
    * @dev gets the underlying asset balance of a user based on the corresponding mToken balance.
    * @param _reserve the reserve address
    ...
    **/
    ...
    function getReserveMTokenAddress(address _reserve) public view returns (address) {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * It's used in the MensaDataProvider specifically to save gas, and avoid
    ...
    **/
    ...
    /**
    * @dev updates the mensa core configuration
    **/
    function refreshConfiguration() external onlyMensaConfigurator {
        refreshConfigInternal();
    }
    ...
    **/
    ...
    ) external onlyMensaConfigurator {
    ...
    **/
    ...
    function disableBorrowingOnReserve(address _reserve) external onlyMensaConfigurator {
    ...
    * @param _reserve the address of the reserve
    **/
    function disableReserveAsCollateral(address _reserve) external onlyMensaConfigurator {
    ...
    * @param _reserve the address of the reserve
    **/
    function enableReserveStableBorrowRate(address _reserve) external onlyMensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function disableReserveStableBorrowRate(address _reserve) external onlyMensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function activateReserve(address _reserve) external onlyMensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function deactivateReserve(address _reserve) external onlyMensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function freezeReserve(address _reserve) external onlyMensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function unfreezeReserve(address _reserve) external onlyMensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    **/
    function refreshConfigInternal() internal {
        mensaAddress = addressesProvider.getMensa();
    }
