...
/**
* @title MensaLiquidationManager contract
* @notice Implements the liquidation function.
**/
contract MensaLiquidationManager is ReentrancyGuard, Ownable, VersionedInitializable {
    ...
    MensaCore core;
    MensaDataProvider dataProvider;
    MensaParametersProvider parametersProvider;
    ...
    **/
    ...
    function init(MensaAddressesProvider _addressesProvider) external onlyOwner {
    ...
    * of the Mensa contract, the getRevision() function is needed.
    */
    ...
    **/
    function liquidationCall(
        ...
        if (_receiveMToken) {
            collateralMToken.transferOnLiquidation(_user, _caller, maxCollateralToLiquidate);
        } else {
